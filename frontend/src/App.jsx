      ...
      <div className="layar__isi">
        ...
        <div className="jendela-peta">
          ...
          <div className="plat plat--kiri-atas">
            ...
            <div className="plat__anak t-label" role="status">{t(`pratinjauPeta.${petaDasar}`)}</div>
          ...
          <div className="atribusi t-label">
            ...
            <span><a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noreferrer">{t("peta.atribusi")}</a>{" | "}<a href="https://carto.com/attributions" target="_blank" rel="noreferrer">{t("pratinjauPeta.carto")}</a></span>
          </div>
